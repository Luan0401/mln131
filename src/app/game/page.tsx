        ...
        <div className="grid grid-cols-1 lg:grid-cols-10 gap-8 items-center min-h-[80vh]">
          ...
          <div className="space-y-6 lg:col-span-4 px-12">
            ...
            <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
              <p>
                Khám phá hiện vật và câu chuyện về xây dựng văn hóa, đạo đức và con người Việt Nam.
              </p>
              
              <p>
                Tìm hiểu thành tựu, hạn chế và giải pháp vun bồi phẩm chất, bản sắc trong thời kỳ mới.
              </p>
            </div>
